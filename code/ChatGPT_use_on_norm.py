# Script calling GPT, providing it with the normalized (RBN) idioms and a prompt tailored to each dialectal group,
...
dfpontus.to_csv("data/pontus_GPTο.csv", index=False)
...
dfsouth.to_csv("data/south_GPTο.csv", index=False)
...
dfnorth.to_csv("data/north_GPTο.csv", index=False)